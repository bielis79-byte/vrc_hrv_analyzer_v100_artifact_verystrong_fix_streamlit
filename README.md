# VRC / HRV RRi Analyzer Pro v10.0
...
## v10.0
- Corrige la corrección de artefactos en modo `very strong`.
- Antes, si detectaba más del 30% de artefactos, la app anulaba toda la corrección.
- Ahora `very strong` no se desactiva automáticamente y usa interpolación robusta.
